...
?>
<br><br><br>
<div class="middle" style="margin:5% auto;  width:800px;">
	   ...
	   <div class="tab-content" id="myTabContent">
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data">
                     ...
                     <button style = "background:black; color:whitesmoke; border:1px solid #ffc107;" type="submit" id="register" name="register" class="btn btn-outline-primary">Register</button>
                     
                </form>
				<br>
			</div>
			<div class="tab-pane fade show" id="login" role="tabpanel" aria-labelledby="home-tab">
			   <a href="vendor_login.php"><button type="button" style="padding:10px; color:whitesmoke;  width:200px; margin-top:30%; margin-left:40%; margin:0px auto; background:black; border:1px solid #ffc107;" class="btn btn-outline-primary" name="login" value="Log In">Log In</button></a>
