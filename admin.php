...
<br><br><br><br><br><br>
<div class="middle" style="  padding:40px; border:1px solid #ffc107; margin:0px auto; width:400px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ffc107;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" id="home-tab" data-toggle="tab" href="#login" role="tab" aria-controls="home" aria-selected="true">Home</a>
              ...
              <a class="nav-link" id="profile-tab" style="color:black;"    aria-controls="profile" aria-selected="false">Welcome Admin</a>
	   ...
	   <!--login Section-- starts-->
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
			  ...
			  <form method="post" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="login" style="background:black; border:1px solid #ffc107;" class="btn btn-primary">Login In</button>
