...
.landing_page{
	...
	background-image: linear-gradient(to bottom, rgb(0, 0, 0, 1),rgba(0, 0, 0, .5)) , url(img/bg2.gif);
...
<nav class="navbar navbar-expand-lg  fixed-top" >
    ...
    <a class="navbar-brand" href="index.php"><span style="color:white;font-family: 'harlow solid', cursive;">Black Pearl</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<div class="landing_page">
		<div class="col-md-4 offset-md-4 logo" style = "margin-top: 5%">
			<img src="img/logo.png" alt="Logo black pearl">
		</div>
		
			
				<!-- <input type="text" class="form-control " placeholder="Search For Food..." aria-label="Search For Food..." aria-describedby="basic-addon2"> -->
...
<div class="menu" style = "margin-top: 0; display:inline; background:grey;">
<span ><h1 style="font-weight : bold; margin-left:33%" >
	Recommended
</h1></span>
	...
	<div class="container-fluid">
		<div class="row"><!--main row-->
			<div class="col-sm-6 mg-4"><!--main row 2 left-->
