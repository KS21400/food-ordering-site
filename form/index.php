...
?>
<br><br><br>
<div class="middle" style=" margin:5% auto;width:500px;">
	   ...
	   <!--login Section-- starts-->
            ...
            <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab">
			    <form method="post" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="register" style="background:black; border:1px solid #ffc107;" class="btn btn-primary">Create New Account</button>
                  <div class="footer" style="color:red;"><?php if(isset($ermsg)) { echo $ermsg; }?><?php if(isset($ermsg2)) { echo $ermsg2; }?></div>
			 </form>
			</div>
